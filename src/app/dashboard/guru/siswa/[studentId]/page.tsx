...
function StudentDetailContent() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const url = classId ? `/api/guru/siswa?class_id=${encodeURIComponent(classId)}` : '/api/guru/siswa'
    ...
    const backHref = `/dashboard/guru/siswa${data?.current_class_id ? `?class_id=${data.current_class_id}` : ''}`
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Student Summary */}
            <Card className="p-6 bg-gradient-to-br from-blue-50 to-primary/5 dark:from-blue-900/20 dark:to-primary/10 border-blue-200/50 dark:border-blue-500/20">
                <div className="flex items-center gap-4">
                    <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-primary flex items-center justify-center text-white text-2xl font-bold shadow-lg shadow-primary/30">
...
export default function SiswaStudentDetail() {
    return (
        <Suspense
            fallback={
                <div className="flex items-center justify-center h-60">
