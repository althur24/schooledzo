                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        ...
                                                        <div className="flex flex-wrap items-center gap-1.5 mt-1.5">
                                                            ...
                                                            <span className="px-1.5 py-0.5 text-xs rounded bg-gray-50 text-gray-500 dark:bg-gray-800 dark:text-gray-400">
                                                                {item.question_type === 'MULTIPLE_CHOICE' ? 'Pilihan Ganda' : item.question_type === 'MULTIPLE_ANSWER' ? 'Ganda Kompleks' : item.question_type === 'TRUE_FALSE' ? 'Benar Salah' : item.question_type === 'SHORT_ANSWER' ? 'Isian Singkat' : 'Essay'}
                                                            </span>
