    ...
    try {
      ...
      `)
        ...
        if (teachingAssignmentId) {
            ...
            // activeYear null → seluruh daftar tugas kosong tanpa sebab.
            ...
            if ((activeYears || []).length > 1) {
                console.warn(`[assignments] Sekolah ${schoolId} punya ${activeYears!.length} tahun aktif — pakai yang terbaru`)
            }
