...
--                  already_done, already_done_students:[{student_id,student_name}] }
-- Idempotent: menjalankan batch yang sama dua kali aman — siswa yang sudah ACTIVE di
-- kelas+tahun tujuan di-skip sebagai already_done, enrollment barunya tidak ditutup.
